...
.PARAMETER DatabaseName
    Name of the database to connect to. Defaults to 'GrmDatabase'.
...
param(
    ...
    [Parameter(Mandatory = $false)]
    [string] $WindowsImage = "freddyk/my:test",

    [Parameter(Mandatory = $false)]
    [string] $DatabaseName = "GrmDatabase",
      ...
      containers:
        - name: $appName
          ...
          env:
            ...
            - name: folders
              value: "c:\\run\\my=https://github.com/BUNKERHOLDINGBC/ContainerScripts/archive/refs/heads/main.zip\\ContainerScripts-main"$additionalEnvYaml
"@
...
Write-Host "  Ports:              80, 443, 7047, 7048, 7049" -ForegroundColor Gray
Write-Host "============================================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  kubectl logs -n $namespace -l app=$appName" -ForegroundColor Gray
